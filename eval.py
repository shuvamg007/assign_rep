...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', default="save_model/model_185.pth", type=str,
                        help='path to model')
    parser.add_argument('-o', '--output_dir', default="test_results/", type=str,
                        help='output dir for drawn images')
    parser.add_argument('-i', '--input_dir', default="icdar_data/images/", type=str, required=False,
